import os, json, pandas as pd, yfinance as yf, schedule, time, requests, threading
...
# ⏰ 排程（每天14:00）
def run_scheduler():
    schedule.every().day.at("14:00").do(scan_market)
    while True:
